    ...
    <html class="ie9" lang="en">
        ...
        <html lang="vi" prefix="og: http://ogp.me/ns#">
            ...
            <head>
                ...
                <link rel="alternate" type="application/json+oembed" href="./wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwww.khoedep.vn%2F" />
                <link rel="alternate" type="text/xml+oembed" href="./wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwww.khoedep.vn%2F&#038;format=xml" />
                ...
                <!--[if lte IE 9]>
                <link rel="stylesheet" type="text/css" href="http://www.khoedep.vn/wp-content/plugins/js_composer/assets/css/vc_lte_ie9.min.css" media="screen">
                <![endif]--><!--[if IE  8]>
                <link rel="stylesheet" type="text/css" href="http://www.khoedep.vn/wp-content/plugins/js_composer/assets/css/vc-ie8.min.css" media="screen">
                <![endif]-->
                ...
                <script>
                    ...
                    var td_ajax_url="http:\/\/www.khoedep.vn\/wp-admin\/admin-ajax.php?td_theme_name=Newspaper&v=7.5";
                ...
                <script>
                    ...
                    OneSignal.push(function() {
                      OneSignal.init({
                        appId: "9d589a85-3292-4308-b0fa-cf9b2df455ff",
                      });
                    });
                </script>
            </head>
            <body class="home page-template page-template-page-pagebuilder-latest page-template-page-pagebuilder-latest-php page page-id-38 trang-chu wpb-js-composer js-comp-ver-4.12.1 vc_responsive td-animation-stack-type0 td-full-layout" itemscope="itemscope" itemtype="http://schema.org/WebPage">
                    ...
                    <div class="td-mobile-container">
                        ...
                        <div class="td-mobile-content">
                            <div class="menu-khoedep-header-container">
                                <ul id="menu-khoedep-header" class="td-mobile-main-menu">
                                    <li id="menu-item-52" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-38 current_page_item menu-item-first menu-item-52"><a href="http://www.khoedep.vn/">Trang Chủ</a></li>
                                    <?php 
                                    ...
                                    <li  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-20875"><a href="{{ route('details', $val->link) }}">{{ $val->namecategory }}</a></li>
                                    @endif
                                    @endforeach
                                    @endif
                ...
                <div class="td-search-wrap-mob">
                    <div class="td-drop-down-search" aria-labelledby="td-header-search-button">
                        <form method="get" class="td-search-form" action="http://www.khoedep.vn/">
                            <!-- close button -->
                        ...
                        <div class="td-container">
                            <div class="td-pb-row">
                                <div class="td-pb-span7 td-sub-footer-menu">
                                    <div class="menu-khoedep-footer-container">
                                        <ul id="menu-khoedep-footer" class="td-subfooter-menu">
                                            <li id="menu-item-34" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-first td-menu-item td-normal-menu menu-item-34"><a href="#">Chính sách</a></li>
        ...
        <!-- Cached page generated by WP-Super-Cache on 2022-11-21 09:31:49 -->
        <!-- super cache -->